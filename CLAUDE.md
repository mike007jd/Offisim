...
This project is indexed by GitNexus as **Offisim** (14987 symbols, 31310 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
