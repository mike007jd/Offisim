...
This project is indexed by GitNexus as **Offisim** (10253 symbols, 21627 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
