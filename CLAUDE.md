...
This project is indexed by GitNexus as **Offisim** (15425 symbols, 32353 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
