...
| `deep-link-install` Rust emit without TS listener | Keep | OS `offisim://install` contract + capability remain; missing listener is a product gap, not deletion license. Prelaunch policy retains deep links. |
