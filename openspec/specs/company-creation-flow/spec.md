...
实现入口：`packages/ui-office/src/components/onboarding/CompanyCreationWizard.tsx`、`apps/web/src/hooks/useCompanyLifecycle.ts.handleCreateYourOwn`、`apps/web/src/hooks/useCompanyBootstrap.ts.PENDING_VIEW_KEY`。
