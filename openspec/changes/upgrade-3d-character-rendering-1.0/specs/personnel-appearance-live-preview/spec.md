...
### Requirement: 3D preview SHALL reflect every appearance schema field
...
### Requirement: Save round-trip propagates ALL appearance fields to all employee surfaces
