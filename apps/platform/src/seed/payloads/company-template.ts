...
export const companyTemplateSeed: OfficialSeedPayload = {
  ...
  summary:
    'Five-seat freelancer / small studio layout with account, creative, copy, QA, and producer roles preconfigured.',
  description: `Full ProcessTemplate adapted from the built-in 'agency-lite' company template: ${agencyLiteTemplate.employees.length} employees plus the agency zone layout. Preview-only in the Market — company templates are created through the first-run wizard today.`,
  version: '1.0.0',
