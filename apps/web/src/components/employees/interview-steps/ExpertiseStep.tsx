...
const EXPERTISE_SUGGESTIONS: Record<string, string[]> = {
  pm: ['Product Strategy', 'User Research', 'Agile/Scrum', 'Data Analysis', 'Roadmapping', 'Stakeholder Management'],
  developer: ['React', 'TypeScript', 'Node.js', 'Python', 'System Design', 'API Design', 'Database', 'DevOps'],
  designer: ['UI Design', 'UX Research', 'Figma', 'Design Systems', 'Prototyping', 'Accessibility', 'Motion Design'],
  qa: ['Test Automation', 'Manual Testing', 'Performance Testing', 'Security Testing', 'CI/CD', 'API Testing'],
  devops: ['Kubernetes', 'Docker', 'AWS', 'CI/CD', 'Terraform', 'Monitoring', 'Linux', 'Networking'],
  analyst: ['SQL', 'Python', 'Data Visualization', 'Statistical Analysis', 'Machine Learning', 'Business Intelligence'],
  engineering_manager: ['Team Leadership', 'Agile', 'Technical Architecture', 'Mentoring', 'Hiring', 'Conflict Resolution'],
};
...
export function ExpertiseStep({ formData, updateField }: ExpertiseStepProps) {
  const suggestions = EXPERTISE_SUGGESTIONS[formData.role_slug] ?? EXPERTISE_SUGGESTIONS['developer'] ?? [];
