...
export type NativeEngineId = 'api' | 'codex';
...
export function createNativeAgentCommandTransport(
  ...
  return {
    executeApi: (args: CommandArgs<'agent_runtime_execute'>) =>
      call('agent_runtime_execute', args),
    resumeApi: (args: CommandArgs<'agent_runtime_resume'>) => call('agent_runtime_resume', args),
    executeCodex: (args: CommandArgs<'codex_agent_execute'>) =>
      call('codex_agent_execute', args),
    resumeCodex: (args: CommandArgs<'codex_agent_resume'>) => call('codex_agent_resume', args),
    enhanceApi: (args: CommandArgs<'agent_runtime_enhance'>) =>
      call('agent_runtime_enhance', args),
    enhanceCodex: (args: CommandArgs<'codex_agent_enhance'>) =>
      call('codex_agent_enhance', args),
    ...
    releaseStream: (
      engineId: NativeEngineId,
      args: CommandArgs<'agent_runtime_release_stream'>,
    ) =>
      engineId === 'codex'
    ...
    stopChild: (args: CommandArgs<'agent_runtime_control'>) =>
      call('agent_runtime_control', args),
  };
}
