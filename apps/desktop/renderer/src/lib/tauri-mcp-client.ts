 ...
 * SSE transport  — delegates to SseMcpClientFactory (composition).
 */
import { invoke } from '@tauri-apps/api/core';
import { SseMcpClientFactory } from './sse-mcp-client';
...
export class TauriMcpClientFactory implements McpClientFactory {
  private readonly sseFallback = new SseMcpClientFactory();
