...
import { createGateway } from '@offisim/core/llm';
import type { LlmGateway } from '@offisim/core/llm';
import type { ModelRegistry, ModelRegistryEntry } from '@offisim/core/llm';
import { ModelResolver } from '@offisim/core/llm';
import { OpenAiAgentsSdkAdapter } from '@offisim/core/llm';
import { assertOpenAiAgentsSdkLaneSupported } from '@offisim/core/llm';
import { RecordedSystemLlmCaller } from '@offisim/core/llm';
import { AuditingToolExecutor } from '@offisim/core/mcp';
import { McpToolExecutor } from '@offisim/core/mcp';
import { NodeContextMiddleware } from '@offisim/core/middleware';
import { SummarizationMiddleware } from '@offisim/core/middleware';
import { UserPreferenceMiddleware } from '@offisim/core/middleware';
import { LlmMiddlewareChain } from '@offisim/core/middleware';
import { ToolPermissionEngine } from '@offisim/core/middleware';
// Heavy imports — direct dist paths to bypass the @offisim/core barrel alias.
import { buildOffisimGraph } from '@offisim/core/runtime';
import { ensureYoloMasterForActiveCompanies } from '@offisim/core/runtime';
import { HookRegistry } from '@offisim/core/runtime';
import { ResumeCoordinator } from '@offisim/core/runtime';
import { createRuntimeContext } from '@offisim/core/runtime';
import { Scratchpad } from '@offisim/core/runtime';
import { SessionCostTracker } from '@offisim/core/runtime';
import { AgentContextPackService } from '@offisim/core/services';
import { ConversationBudgetService } from '@offisim/core/services';
import { createRuntimeRollingJournal } from '@offisim/core/services';
import { FileHistoryService, FileHistoryToolExecutor } from '@offisim/core/services';
import { GitAutoCommitService } from '@offisim/core/services';
import type { GitExec } from '@offisim/core/services';
import { InteractionService } from '@offisim/core/services';
import { MemoryService } from '@offisim/core/services';
import { ToolTelemetryService } from '@offisim/core/services';
import { UserMemoryService } from '@offisim/core/services';
import { type BuiltinTool, createBuiltinTools } from '@offisim/core/tools';
import type { FsAdapter, ShellExec, ShellExecResult } from '@offisim/core/tools';
import { CompositeToolExecutor } from '@offisim/core/tools';
 ...
 * 1. Repos: Drizzle sqlite-proxy -> persistent SQLite
 * 2. Checkpointer: TauriCheckpointSaver -> persistent checkpoints
 * 3. Gateway: direct API calls through tauri-plugin-cors-fetch
...
export async function createTauriRuntime(
  ...
  const { OrchestrationService } = await import('@offisim/core/services');
