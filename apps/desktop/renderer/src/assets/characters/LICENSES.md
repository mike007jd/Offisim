...
You can get the other version from the website https://quaternius.com
...
- License: CC0 1.0 Universal (public domain) — https://creativecommons.org/publicdomain/zero/1.0/
- Used for: Animation clips (idle/talk/walk/sit/interact/pickup/dance families).
...
## Universal Animation Library 2 [Standard] — Quaternius

- Source: https://quaternius.itch.io/universal-animation-library-2
- License: CC0 1.0 Universal (public domain) — https://creativecommons.org/publicdomain/zero/1.0/
- Used for: Animation clips (fold-arms/head-shake/phone/carry/chest-open/consume/yes).
...
## Furniture Kit (2.0) — Kenney (kenney.nl)
