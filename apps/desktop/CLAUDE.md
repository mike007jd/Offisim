...
- Privileged Tauri invokes must be grouped behind explicit capabilities. Project fs/shell commands use `offisim:fs-shell`, and local agent/LLM bridge commands use `offisim:agent-bridges`.
