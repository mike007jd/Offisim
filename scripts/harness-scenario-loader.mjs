...
export const REPLAY_SCENARIO_IDS = [
  ...
  'boss-summary-single-artifact-output',
  'boss-summary-single-artifact-already-emitted-no-duplicate',
  'boss-summary-ordinary-team-summary-no-deliverable',
  'boss-summary-existing-document-no-deliverable',
  'completion-without-taskrunid-defaults-to-blocked',
  'completion-coffee-tagline-no-deliverable',
  'completion-chinese-chat-no-deliverable',
  'completion-explicit-markdown-file-emits-deliverable',
  'completion-read-existing-file-no-deliverable',
  'completion-bare-filename-text-repairs-deliverable',
  'completion-document-deliverable-no-boss-duplicate',
  ...
  'completion-verification-tool-evidence-completes',
  'completion-workspace-read-blocks-without-evidence',
  ...
  'tool-loop-duplicate-call-id-skips-side-effect',
  'tool-loop-max-rounds-fails-fast',
  'mainstream-agent-gap-boundary',
  'cancellation-model-turn-cancels-task-run',
  'cancellation-tool-request-cancels-before-side-effect',
  ...
  'pm-planner-typed-sop-run-uses-selected-id',
