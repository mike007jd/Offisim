...
const paths = {
  ...
  sandboxTools: `${ROOT}/apps/desktop/src-tauri/src/builtin/sandbox_path.rs`,
  shellTools: `${ROOT}/apps/desktop/src-tauri/src/builtin/shell.rs`,
...
function verifyRustBehavioralOracleNames(): void {
  const tests = [
    ...
    [paths.shellTools, 'evaluation_shell_timeout_is_bounded_by_backend_and_lease'],
    [paths.shellTools, 'evaluation_shell_reuses_the_rust_deny_classifier'],
    [paths.shellTools, 'evaluation_pipe_reader_stops_at_the_backend_memory_cap'],
    [paths.shellTools, 'evaluation_process_group_termination_reaps_descendants'],
    [paths.shellTools, 'evaluation_successful_leader_exit_still_reaps_background_descendants'],
    [
      paths.shellTools,
      'shell_lifetime_marker_reaps_a_close_fds_detached_child_that_keeps_environment_marker',
    ],
    [paths.shellTools, 'shell_lifetime_cleanup_documents_marker_stripping_daemon_boundary'],
  ] as const;
