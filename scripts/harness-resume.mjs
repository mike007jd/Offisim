...
const { runResumeEquivalenceHarness } = await import(
  new URL('../packages/core/dist/testing/resume-runner.js', import.meta.url).href
);
...
const report = await runResumeEquivalenceHarness(loadHarnessScenarios());
