...
This project is indexed by GitNexus as **Offisim** (15380 symbols, 26838 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
