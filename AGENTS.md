...
This project is indexed by GitNexus as **Offisim** (9296 symbols, 19550 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
