...
This project is indexed by GitNexus as **Offisim** (20443 symbols, 43984 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
