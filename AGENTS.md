...
This project is indexed by GitNexus as **Offisim** (9990 symbols, 21069 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
