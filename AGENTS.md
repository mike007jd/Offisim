...
This project is indexed by GitNexus as **Offisim** (9884 symbols, 20880 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
