...
This project is indexed by GitNexus as **Offisim** (9447 symbols, 19920 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
