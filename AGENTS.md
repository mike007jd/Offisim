...
This project is indexed by GitNexus as **Offisim** (8419 symbols, 17868 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
