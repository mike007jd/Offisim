...
export const MOCK_MANIFEST: PackageManifest = {
  ...
  integrity: {
    package_sha256: '9f2c9f2c9f2c9f2c9f2c9f2c9f2c9f2c9f2c9f2c9f2c9f2c9f2c9f2c9f2c9f2c',
    files: [
      {
        path: 'assets/employee.writer-pro.json',
        sha256: '8a1f8a1f8a1f8a1f8a1f8a1f8a1f8a1f8a1f8a1f8a1f8a1f8a1f8a1f8a1f8a1f',
      },
    ],
  },
  previews: {
    icon_path: 'previews/icon.png',
    readme_path: 'README.md',
  },
};

export const MOCK_BINDING_REQUIREMENTS: BindingRequirement[] = [
  {
    assetId: 'writer-pro-default',
    assetKind: 'employee',
    bindingType: 'model_profile',
    bindingKey: 'writer-pro-default:reasoning-heavy',
    required: false,
    hint: 'outline and critique',
  },
  {
    assetId: 'writer-pro-default',
    assetKind: 'employee',
    bindingType: 'model_profile',
    bindingKey: 'writer-pro-default:cheap-draft',
    required: false,
    hint: 'bulk drafting',
  },
];

export const MOCK_INSTALL_PLAN: InstallPlan = {
  manifest: MOCK_MANIFEST,
  compatibility: { compatible: true, errors: [] },
  bindings: MOCK_BINDING_REQUIREMENTS,
  needsConfirmation: true,
  confirmationReasons: [
    'Package has network access (limited)',
    'Package has filesystem access (workspace)',
  ],
  packageHash: '9f2c9f2c9f2c...',
