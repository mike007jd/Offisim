...
export const ZONES: readonly ZoneDef[] = [
  ...
  { id: 'dev', label: 'DEVELOPMENT', accent: '#3b82f6', cx: -13, cz: 11, w: 12, d: 8, type: 'dept', roleSlugs: ['developer', 'engineer', 'backend', 'frontend', 'fullstack', 'writer'], deskSlots: 4, spaceType: 'Work Zone' },
  { id: 'prod', label: 'PRODUCT', accent: '#a855f7', cx: 0, cz: 11, w: 10, d: 8, type: 'dept', roleSlugs: ['pm', 'product_manager', 'researcher', 'analyst', 'manager', 'seo_specialist', 'project_manager', 'account_manager', 'qa'], deskSlots: 4, spaceType: 'Work Zone' },
  { id: 'art', label: 'ART & DESIGN', accent: '#f97316', cx: 12, cz: 11, w: 10, d: 8, type: 'dept', roleSlugs: ['designer', 'artist', 'ui_designer', 'ux_designer', 'graphic_designer'], deskSlots: 4, spaceType: 'Work Zone' },
];
