...
export const STAGE_META: Record<NonNullable<PipelineStage>, StageMeta> = {
  ...
  manager: {
    ...
    chatColorClass: 'text-orange-400',
  ...
  executing: {
    ...
    chatColorClass: 'text-emerald-400',
    chatLabel: 'Executing…',
    shortLabel: 'Employee',
  },
  summary: {
    label: 'DELIVERING',
    colorClass: 'text-purple-400/90',
    dotClass: 'bg-purple-400',
    chatColorClass: 'text-purple-400',
