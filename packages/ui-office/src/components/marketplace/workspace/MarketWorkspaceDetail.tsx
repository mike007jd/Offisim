...
import { ArrowLeft, Download, ExternalLink, Shield, Star } from 'lucide-react';
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        const readmePreview = detailResponse.previews?.find((p) => p.kind === 'readme');
        ...
        // Treat 404-like errors as unavailable
            ...
            <div className="flex min-w-0 items-start gap-4">
              ...
              <div className="min-w-0">
                ...
                <h2 className="truncate text-2xl font-semibold text-white">
                  {loading ? 'Loading…' : (detail?.title ?? 'Unknown')}
                </h2>
                {detail ? (
