...
export function SopViewSurface({
  ...
  return (
    <div className="sop-view-shell" data-layout-tier={tier}>
      <ToastBanner toasts={toasts} onDismiss={dismissToast} />

      {showInlineSidebar && sidebar}

      <div className="sop-view-center">
        <SopLibraryBar
          selectedSopId={sessionState.selectedSopId}
        ...
        {saveStatus !== 'idle' && (
          <div className="sop-save-region">
            <span className="sop-save-pill" data-state={saveStatus}>
              {saveStatus === 'saving'
                ? 'Saving…'
                : saveStatus === 'saved'
                  ? 'All changes saved'
      ...
      {showInspectorHandle && (
        <Button
          ...
          variant="ghost"
          size="icon"
          className="sop-inspector-handle"
          onClick={() => setInspectorOpen((prev) => !prev)}
          aria-label={inspectorOpen ? 'Close SOP inspector' : 'Open SOP inspector'}
        >
          {inspectorOpen ? (
            <PanelRightClose data-icon="inspector-handle" />
          ) : (
            <PanelRightOpen data-icon="inspector-handle" />
          )}
        </Button>
      )}

      {showInspectorOverlay && (
        <div className="sop-inspector-overlay">
          <div className="sop-inspector-overlay-header">
            <Button
              type="button"
              variant="ghost"
              size="icon"
          ...
          <SopInspectorPanel
            ...
            onSelectStep={handleStepClick}
            missingRoleSet={missingRoleSet}
            className="sop-inspector-overlay-panel"
          />
        </div>
      )}

      {sidebarDrawerOpen && tier === 'narrow' && (
        <div className="sop-sidebar-drawer">
          <Button
            type="button"
            variant="ghost"
            aria-label="Close SOP list"
            className="sop-sidebar-scrim"
            onClick={() => setSidebarDrawerOpen(false)}
          />
          <div className="sop-sidebar-drawer-panel">{sidebar}</div>
        </div>
      )}

      {showInspectorSheet && (
        <div className="sop-inspector-sheet">
          <div className="sop-inspector-sheet-header">
          ...
          <SopInspectorPanel
            ...
            onSelectStep={handleStepClick}
            missingRoleSet={missingRoleSet}
            className="sop-inspector-sheet-panel"
          />
        </div>
      )}
      ...
      {addStepPopover && (
        <SopAddStepPopover
          ...
          anchor={
            ...
            <div className="sop-popover-anchor" style={addStepAnchorStyle} />
          }
          initialValues={
