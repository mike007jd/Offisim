-- 028: Deterministic harness foundation.
-- Runtime-applied db-local migration. Docs/03_migrations/.../036_* mirrors
-- this content under the local-v0.1 documentation sequence.
--
