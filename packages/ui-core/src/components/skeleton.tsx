...
export function WorkspaceListSkeleton({ rows = 6, className }: WorkspaceListSkeletonProps) {
  return (
    <div className={cn('space-y-3 p-3', className)} data-skeleton="workspace-list">
...
export function WorkspaceDetailSkeleton({ className }: WorkspaceDetailSkeletonProps) {
  return (
    <div className={cn('space-y-6 p-6', className)} data-skeleton="workspace-detail">
  ...
  return (
    ...
    >
      ...
      <div className="grid min-h-0 flex-1 grid-cols-1 gap-4 md:grid-cols-[280px_minmax(0,1fr)]">
        ...
        <WorkspaceDetailSkeleton className="min-h-0 rounded-xl border border-border-subtle bg-surface-elevated/40" />
      </div>
    </div>
  );
}
