...
export const aiStartupTemplate: CompanyTemplate = {
  ...
  layoutPreset: 'ai-lab',
  zones: [
    createZoneBlueprint({ slug: 'zone-dev', archetype: 'workspace', label: 'ML LAB', accentColor: '#06b6d4', floorColor: 0x1f4050, cx: -8, cz: 10, w: 14, d: 10, targetRoles: ['researcher', 'backend'], deskSlots: 3, sortOrder: 0 }),
    createZoneBlueprint({ slug: 'zone-art', archetype: 'workspace', label: 'ENGINEERING', accentColor: '#f97316', floorColor: 0x5c3b2a, cx: 10, cz: 10, w: 10, d: 8, targetRoles: ['fullstack', 'frontend', 'ux_designer', 'product_manager'], deskSlots: 3, sortOrder: 1 }),
    {
      ...createZoneBlueprint({ slug: 'zone-server', archetype: 'server', label: 'GPU CLUSTER', cx: 0, cz: -1, w: 14, d: 8, sortOrder: 2 }),
      defaultPrefabs: [
    ...
    createZoneBlueprint({ slug: 'zone-rest', archetype: 'rest', label: 'REST AREA', cx: -10, cz: -11, w: 8, d: 6, sortOrder: 3 }),
    createZoneBlueprint({ slug: 'zone-meeting', archetype: 'meeting', label: 'MEETING', cx: 10, cz: -11, w: 7, d: 6, sortOrder: 4 }),
  ],
};
