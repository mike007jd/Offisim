...
export const DEFAULT_COST_RATES: Array<{
  ...
  { provider: 'anthropic', model_pattern: 'claude-sonnet-4*', input_cost_per_mtok: 3, output_cost_per_mtok: 15 },
  ...
  { provider: 'openai-compat', model_pattern: 'gemini-2.0-flash*', input_cost_per_mtok: 0.1, output_cost_per_mtok: 0.4 },
];
