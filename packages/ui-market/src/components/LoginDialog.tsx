      ...
      <div className="w-full max-w-sm rounded-lg bg-white p-6 shadow-xl">
        ...
        <div className="mb-4 flex flex-col gap-2">
          <button
            ...
            disabled={isLoading}
            className="flex items-center justify-center gap-2 rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50"
          >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          {mode === 'sign-up' && (
            <div>
              <label htmlFor="login-display-name" className="mb-1 block text-sm font-medium text-gray-700">
                Display name
              </label>
              <input
