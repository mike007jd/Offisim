...
export type RoleSlug =
  // System / management
  | 'boss' | 'hr' | 'manager'
  | 'product_manager' | 'project_manager' | 'account_manager' | 'engineering_manager'
  // Dev
  | 'developer' | 'engineer' | 'backend' | 'frontend' | 'fullstack'
  | 'data_engineer' | 'devops'
  // Art
  | 'designer' | 'artist' | 'ui_designer' | 'ux_designer' | 'graphic_designer'
  // Content
  | 'writer' | 'marketer' | 'seo_specialist'
  // Analysis / Product
  | 'pm' | 'analyst' | 'researcher' | 'qa';
...
export const ROLE_REGISTRY: readonly RoleEntry[] = [
  ...
  { slug: 'engineering_manager',label: 'Engineering Manager',  department: 'product', isSystem: true },
  // Dev
