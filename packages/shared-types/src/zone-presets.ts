...
const TEAM_OFFICE: ZonePreset = {
  ...
  activityTypes: ['work'],
  prefabs: [
    { prefabId: 'workstation-standard', offsetX: -3, offsetZ: -1.5 },
    { prefabId: 'workstation-standard', offsetX: 0, offsetZ: -1.5 },
    { prefabId: 'workstation-standard', offsetX: -3, offsetZ: 1.5 },
    { prefabId: 'workstation-standard', offsetX: 0, offsetZ: 1.5 },
    { prefabId: 'filing-cabinet', offsetX: 4, offsetZ: -3 },
    { prefabId: 'plant-small', offsetX: -5, offsetZ: -3.5 },
...
const LARGE_OFFICE: ZonePreset = {
  ...
  prefabs: [
    // Row 1
    { prefabId: 'workstation-standard', offsetX: -4, offsetZ: -2 },
    { prefabId: 'workstation-standard', offsetX: 0, offsetZ: -2 },
    { prefabId: 'workstation-standard', offsetX: 4, offsetZ: -2 },
    // Row 2
    { prefabId: 'workstation-standard', offsetX: -4, offsetZ: 2 },
    { prefabId: 'workstation-standard', offsetX: 0, offsetZ: 2 },
    { prefabId: 'workstation-standard', offsetX: 4, offsetZ: 2 },
    // Amenities
    { prefabId: 'standing-table', offsetX: 7, offsetZ: 0 },
    { prefabId: 'water-cooler', offsetX: -7, offsetZ: -4 },
    { prefabId: 'plant-large', offsetX: -7, offsetZ: 4 },
    { prefabId: 'plant-small', offsetX: 7, offsetZ: 4 },
  ],
};
