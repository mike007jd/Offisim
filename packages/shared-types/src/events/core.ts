...
export type EventFamily =
  ...
  | 'company.startup.requested'
  | 'company.startup.started'
  | 'company.startup.completed'
  | 'company.startup.skipped'
  ...
  | 'scene.employee.performance.changed'
  | 'llm.call.started'
  | 'llm.call.completed'
  | 'llm.usage.recorded'
  | 'graph.node.entered'
  ...
  | 'execution.resumed'
  | 'execution.aborted'
  | 'plan.dispatcher.recursion_limit'
